...
const translations = {
  EN: {
    ...
    "aiMastering.description":
      "Professional-grade mastering powered by AI technology",
    "aiMastering.premiumFeature": "Premium Feature",
    "aiMastering.unlockMessage":
      "Unlock AI-powered mastering to take your tracks to the next level",
    ...
    "aiMastering.processingMessage":
      "This may take a few minutes depending on file size",
    "aiMastering.infoBanner":
    ...
    "aiMastering.errorMessage":
      "Failed to process your track. Please try again.",
  ...
  ES: {
    ...
    "upload.uploadFormats":
      ".MP3, .WAV, .FLAC (Máximo 100MB cada uno, 20 archivos)",
    "upload.agreeToTerms":
      "Acepto los Términos y Condiciones y reconozco el Aviso de Copyright. Confirmo que soy propietario o tengo la autorización adecuada para todos los archivos de audio que subo y proceso a través de este servicio.",
    "upload.pleaseAcceptTerms":
      "Por favor, acepta los Términos y Condiciones para habilitar la carga de archivos.",
    "upload.noTracksUploaded": "Aún no se han subido pistas",
    "upload.uploadAudioFiles":
      "Sube archivos de audio para verlos listados aquí",
    ...
    "aiMastering.description":
      "Masterización de nivel profesional impulsada por tecnología IA",
    "aiMastering.premiumFeature": "Función Premium",
    "aiMastering.unlockMessage":
      "Desbloquea la masterización con IA para llevar tus pistas al siguiente nivel",
    "aiMastering.feature1": "Análisis y mejora de audio con IA",
    "aiMastering.feature2":
      "Coincide perfectamente con tus pistas de referencia",
    ...
    "aiMastering.infoBanner":
      "Tus datos de audio nunca se suben a ningún servidor, todo el procesamiento ocurre localmente en tu navegador. Esto garantiza que tu audio permanezca seguro y en tu computadora. La tasa de muestreo óptima es de 48 kHz.",
    ...
    "aiMastering.loudnessCorrectionLimiting":
      "Limitación de Corrección de Volumen",
    ...
    "aiMastering.errorMessage":
      "Fallo al procesar tu pista. Por favor intenta de nuevo.",
