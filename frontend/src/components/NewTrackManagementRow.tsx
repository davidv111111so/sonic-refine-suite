...
export const NewTrackManagementRow = ({
  ...
  const audioUrl = file.originalFile
    ? URL.createObjectURL(file.originalFile)
    : file.enhancedUrl || "";
  return (
    <div className="grid grid-cols-7 gap-4 p-4 bg-gradient-to-br from-slate-800/30 to-slate-900/50 border border-slate-600 rounded-lg hover:from-slate-700/40 hover:to-slate-800/60 transition-all duration-300">
      ...
      <div className="col-span-2 flex flex-col min-w-0">
        <div className="flex items-center gap-2 mb-1">
          ...
          <div className="flex-1 min-w-0 overflow-hidden">
            <div
              className="bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 bg-clip-text text-transparent font-bold break-words"
              style={{
                display: "-webkit-box",
                WebkitLineClamp: 2,
        ...
        {audioUrl && (
          <div className="flex items-center gap-2 mt-1">
            <Button
              ...
              className="h-7 w-7 p-0 bg-slate-700 border-slate-500 hover:bg-slate-600"
            >
              {isPlaying ? (
      ...
      <div className="flex flex-col justify-center">
        ...
        <Badge
          variant="outline"
          className="text-xs w-fit bg-purple-700/30 text-purple-200 border-purple-500/50"
        >
      ...
      <div className="flex flex-col justify-center gap-1">
        {file.status === "uploaded" ? (
          ...
          <Badge
            variant="outline"
            className="text-xs w-fit bg-green-700/30 text-green-200 border-green-500/50"
          >
      ...
      <div className="flex items-center gap-2">
        {onFileInfo && (
          <Button
            ...
            className="text-xs bg-slate-700 border-slate-500 hover:bg-slate-600 text-orange-600"
          >
        ...
        <Button
          ...
          className="text-xs bg-red-700/50 border-red-500 hover:bg-red-600 text-red-200"
        >
          <X className="h-3 w-3" />
        </Button>
      </div>
