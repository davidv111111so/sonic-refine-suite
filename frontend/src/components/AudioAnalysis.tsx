        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-700/50 rounded p-3">
            ...
            <div className="text-2xl font-bold text-white">
              {analysis.dynamicRange} dB
            </div>
            <p className="text-xs text-slate-400 mt-1">
              {analysis.dynamicRange > 20
                ? "Excellent"
                : analysis.dynamicRange > 14
                  ? "Good"
          ...
          <div className="bg-slate-700/50 rounded p-3">
            ...
            <div className="text-2xl font-bold text-white">
              {analysis.peakAmplitude} dBFS
            </div>
            <p className="text-xs text-slate-400 mt-1">
              {analysis.peakAmplitude > -1
                ? "Warning: Potential clipping"
                : analysis.peakAmplitude > -3
                  ? "Good headroom"
          ...
          <div className="bg-slate-700/50 rounded p-3">
            ...
            <div className="text-2xl font-bold text-white">
              {analysis.averageRms} dBFS
            </div>
            <p className="text-xs text-slate-400 mt-1">
              {analysis.averageRms > -12
                ? "Potentially too loud"
                : analysis.averageRms > -18
                  ? "Good loudness level"
          ...
          <div className="bg-slate-700/50 rounded p-3">
            ...
            <div className="text-2xl font-bold text-white">
              {analysis.noiseFloor} dBFS
            </div>
            <p className="text-xs text-slate-400 mt-1">
              {analysis.noiseFloor > -60
                ? "High background noise"
                : analysis.noiseFloor > -70
                  ? "Average noise level"
