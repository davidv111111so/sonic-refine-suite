...
export const CompactEnhancementSettings = ({
    ...
    if (onApplyPreset) {
      ...
      onApplyPreset = (presetSettings: any) => {
        if (presetSettings.noiseReduction !== undefined) {
          setSettings((prev) => ({
            ...prev,
            noiseReduction: presetSettings.noiseReduction,
          }));
        ...
        if (presetSettings.compression !== undefined) {
          setSettings((prev) => ({
            ...prev,
            compression: presetSettings.compression,
          }));
        ...
        if (presetSettings.stereoWidening !== undefined) {
          setSettings((prev) => ({
            ...prev,
            stereoWidening: presetSettings.stereoWidening,
          }));
        ...
        if (presetSettings.bassBoost !== undefined) {
          setSettings((prev) => ({
            ...prev,
            bassBoost: presetSettings.bassBoost,
          }));
        }
        if (presetSettings.midBoost !== undefined) {
          setSettings((prev) => ({
            ...prev,
            midBoost: presetSettings.midBoost,
          }));
        }
        if (presetSettings.trebleBoost !== undefined) {
          setSettings((prev) => ({
            ...prev,
            trebleBoost: presetSettings.trebleBoost,
          }));
        }
  ...
  const CustomSlider = ({
    ...
    <div
      className={`transition-all duration-300 ${!enabled ? "opacity-30 pointer-events-none grayscale" : ""}`}
    >
        ...
        <CardContent className="pt-0 space-y-6">
          ...
          <div className="flex items-center justify-around p-6 bg-gradient-to-r from-slate-800/80 to-slate-700/80 rounded-xl border border-slate-600 backdrop-blur-sm">
            ...
            <div className="flex flex-col items-center gap-3">
              <ToggleButton
                ...
                onToggle={() =>
                  setStereoWideningEnabled(!stereoWideningEnabled)
                }
          ...
          <div className="space-y-4">
            ...
            <CustomSlider
              ...
              onChange={(value: number) =>
                setSettings({ ...settings, compression: value })
              }
              label="Compression"
              color="#f59e0b"
            />
            ...
            <CustomSlider
              ...
              onChange={(value: number) =>
                setSettings({ ...settings, stereoWidening: value })
              }
              label="Stereo Widening"
              color="#a855f7"
            />
          ...
          <div className="space-y-3 pt-4 border-t border-slate-700">
            <div className="flex items-center space-x-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setSettings({ ...settings, normalization: !!checked })
                }
            ...
            <div className="flex items-center space-x-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setSettings({ ...settings, highFreqRestoration: !!checked })
                }
                className="border-slate-500"
              />
              <label
          ...
          <Button
            ...
            style={{
              boxShadow:
                !hasFiles || isProcessing
                  ? ""
                  : "0 0 40px rgba(147, 51, 234, 0.6), 0 0 80px rgba(59, 130, 246, 0.4), 0 0 120px rgba(6, 182, 212, 0.2)",
