      ...
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-6 gap-4 p-4 bg-gradient-to-r from-slate-700/50 to-slate-800/50 dark:from-black/80 dark:to-slate-900/80 rounded-lg text-sm font-medium border border-slate-600 dark:border-slate-700">
            ...
            <div className="bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 bg-clip-text text-transparent font-bold animate-pulse">
              File Size
            </div>
            <div className="bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 bg-clip-text text-transparent font-bold animate-pulse">
              Status
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col min-w-0 max-w-full">
                  ...
                  <span className="bg-gradient-to-r from-purple-200 via-pink-200 to-blue-200 bg-clip-text text-transparent text-xs truncate animate-pulse">
                    {file.artist || "Unknown Artist"}
                  </span>
                  <div className="flex items-center gap-2 mt-1">
                    <Badge
                      variant="outline"
                      className="text-xs px-2 py-0 bg-slate-700/50 dark:bg-black/70 text-white dark:text-white border-slate-500 dark:border-slate-600"
                    >
                  ...
                  {file.status === "enhanced" && file.enhancedSize ? (
                    <div className="space-y-1">
                      <div className="flex items-center gap-1">
                        <span className="text-xs bg-gradient-to-r from-cyan-200 to-blue-200 bg-clip-text text-transparent font-semibold animate-pulse">
                          Antes:
                        </span>
                        <span className="bg-gradient-to-r from-slate-300 to-slate-400 bg-clip-text text-transparent text-xs font-mono line-through animate-pulse">
                          {formatFileSize(file.size)}
                        </span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="text-xs bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent font-semibold animate-pulse">
                          Después:
                        </span>
                        <span className="bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent text-sm font-mono font-bold animate-pulse">
                      ...
                      <div className="text-xs bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent font-semibold animate-pulse">
                        (+
                        {Math.round(
                          ((file.enhancedSize - file.size) / file.size) * 100,
                        )}
                        %)
                      </div>
                    </div>
                    ...
                    <div>
                      <span className="bg-gradient-to-r from-cyan-200 to-blue-200 bg-clip-text text-transparent text-sm font-mono font-bold animate-pulse">
                        {formatFileSize(file.size)}
                      </span>
                      <span className="text-xs bg-gradient-to-r from-purple-200 to-pink-200 bg-clip-text text-transparent block animate-pulse">
                        / 100MB max
                      </span>
                    </div>
                  )}
                ...
                <div className="flex flex-col justify-center bg-zinc-950">
                  ...
                  file.status === "enhanced" ? (
                    <div className="text-xs bg-gradient-to-r from-blue-900/30 to-green-900/30 dark:from-blue-950/50 dark:to-green-950/50 p-2 rounded-md border border-blue-500/30 dark:border-blue-600/40">
                      <div className="flex items-center gap-1 mb-1">
                        <span className="font-medium text-blue-300 dark:text-blue-200">
                          Source:
                        </span>
                        <Badge
                          variant="outline"
                          className="text-xs px-1.5 py-0 bg-orange-700/50 dark:bg-orange-800/60 text-orange-200 dark:text-orange-100 border-orange-500/50 dark:border-orange-600/50 font-medium"
                        >
                          {fileType.toUpperCase()}
                        </Badge>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="font-medium text-green-300 dark:text-green-200">
                          Output:
                        </span>
                        <Badge
                          variant="outline"
                          className="text-xs px-1.5 py-0 bg-green-700/50 dark:bg-green-800/60 text-green-200 dark:text-green-100 border-green-500/50 dark:border-green-600/50 font-medium"
                        >
                      ...
                      {file.status === "enhanced" && file.enhancedSize && (
                        <div className="flex items-center gap-1 mt-1">
                          <span className="font-medium text-cyan-300 dark:text-cyan-200">
                            Size:
                          </span>
                          <Badge
                            variant="outline"
                            className="text-xs px-1.5 py-0 bg-cyan-700/50 dark:bg-cyan-800/60 text-cyan-200 dark:text-cyan-100 border-cyan-500/50 dark:border-cyan-600/50 font-medium"
                          >
                            {formatFileSize(file.enhancedSize)}
                          </Badge>
                        </div>
                ...
                <div className="flex items-center">
                  <Button
                    ...
                    className="text-xs bg-slate-700 dark:bg-black/80 border-slate-500 dark:border-slate-700 hover:bg-slate-600 dark:hover:bg-slate-900 text-amber-300"
                  >
          ...
          <div className="mt-6 pt-4 border-t border-slate-600 dark:border-slate-700">
            <div className="flex justify-between items-center mb-4">
              <div className="flex gap-3">
                ...
                {enhancedHistory.filter((f) => f.status === "enhanced")
                  .length >= 2 && (
                  <Button
            ...
            <div className="grid grid-cols-4 gap-4 text-center">
              <div className="rounded-lg p-3 border border-slate-600/50 dark:border-slate-700/50 bg-slate-600">
                <div className="text-sm bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 bg-clip-text text-transparent font-bold animate-pulse">
                  Total Files
                </div>
              ...
              <div
                className={`bg-blue-700/30 dark:bg-blue-900/40 rounded-lg p-3 border border-blue-600/50 dark:border-blue-700/50 ${allFiles.filter((f) => f.status === "uploaded").length > 0 ? "animate-pulse shadow-lg shadow-blue-500/50" : ""}`}
              >
                <div className="text-sm bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 bg-clip-text text-transparent font-bold animate-pulse">
                  In Queue
                </div>
                <div
                  className={`text-xl font-bold ${allFiles.filter((f) => f.status === "uploaded").length > 0 ? "text-blue-300 animate-pulse" : "text-blue-400 dark:text-blue-300"}`}
                >
                  {allFiles.filter((f) => f.status === "uploaded").length}
                </div>
              </div>
              <div
                className={`bg-orange-700/30 dark:bg-orange-900/40 rounded-lg p-3 border border-orange-600/50 dark:border-orange-700/50 ${allFiles.filter((f) => f.status === "processing").length > 0 ? "animate-pulse shadow-lg shadow-orange-500/50" : ""}`}
              >
                <div className="text-sm bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 bg-clip-text text-transparent font-bold animate-pulse">
                  Processing
                </div>
                <div
                  className={`text-xl font-bold ${allFiles.filter((f) => f.status === "processing").length > 0 ? "text-orange-300 animate-pulse" : "text-orange-400 dark:text-orange-300"}`}
                >
                  {allFiles.filter((f) => f.status === "processing").length}
                </div>
              </div>
              <div
                className={`bg-green-700/30 dark:bg-green-900/40 rounded-lg p-3 border border-green-600/50 dark:border-green-700/50 ${allFiles.filter((f) => f.status === "enhanced").length > 0 ? "animate-pulse shadow-lg shadow-green-500/50" : ""}`}
              >
                <div className="text-sm bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 bg-clip-text text-transparent font-bold animate-pulse">
                  Enhanced
                </div>
                <div
                  className={`text-xl font-bold ${allFiles.filter((f) => f.status === "enhanced").length > 0 ? "text-green-300 animate-pulse" : "text-green-400 dark:text-green-300"}`}
                >
