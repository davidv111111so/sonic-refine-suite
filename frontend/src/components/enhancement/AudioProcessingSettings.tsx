        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              onSettingChange("noiseReductionEnabled", checked)
            }
          />
        </div>
        {settings.noiseReductionEnabled && (
          <div className="space-y-1">
            ...
            <Slider
              ...
              onValueChange={([value]) =>
                onSettingChange("noiseReduction", value)
              }
              min={0}
              max={100}
              step={5}
        ...
        {settings.normalize && (
          <div className="space-y-1">
            ...
            <Slider
              ...
              onValueChange={([value]) =>
                onSettingChange("normalizeLevel", value)
              }
              min={-12}
              max={0}
              step={1}
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              onSettingChange("compressionEnabled", checked)
            }
          />
        </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              onSettingChange("stereoWideningEnabled", checked)
            }
          />
        </div>
        {settings.stereoWideningEnabled && (
          <div className="space-y-1">
            ...
            <Slider
              ...
              onValueChange={([value]) =>
                onSettingChange("stereoWidening", value)
              }
              min={0}
              max={100}
              step={5}
