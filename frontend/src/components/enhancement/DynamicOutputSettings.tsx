...
export const DynamicOutputSettings = ({
  ...
  return (
    <Card className="bg-slate-900/90 dark:bg-black/90 border-slate-700 dark:border-slate-800 my-[52px]">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              value={outputFormat}
              onChange={(e) =>
                onOutputFormatChange(e.target.value as "mp3" | "wav" | "flac")
              }
          ...
          {outputFormat === "mp3" ? (
            ...
            <div>
              ...
              <select
                value={bitDepth}
                onChange={(e) =>
                  onBitDepthChange(parseInt(e.target.value) as 16 | 24)
                }
                className="w-full bg-slate-800 dark:bg-black border border-slate-700 dark:border-slate-800 text-white rounded-md px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
              >
        ...
        <div className="p-3 rounded border border-slate-700 dark:border-slate-800 bg-sky-950">
          <div className="text-xs space-y-1">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-xs text-teal-100">
            ...
            <div className="flex justify-between">
              <span className="bg-gradient-to-r from-green-200 to-emerald-200 bg-clip-text text-transparent font-bold">
                Type:
              </span>
