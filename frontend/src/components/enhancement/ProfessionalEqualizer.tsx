...
const EQ_PRESETS = [
  {
    ...
    nameES: "Jazz",
    icon: Music2,
    values: [2, 1, 0, 1, 2, 3, 2, 1, 2, 2],
  },
  {
    name: "Electronic",
    nameES: "Electrónica",
    icon: Disc3,
    values: [5, 4, 2, 0, -2, 2, 3, 4, 5, 6],
  },
  {
    name: "Podcast",
    nameES: "Podcast",
    icon: MessageSquare,
    values: [2, 3, 5, 4, 2, 0, -2, -3, -2, 0],
  },
  {
    name: "Reggae",
    nameES: "Reggae",
    icon: Waves,
    values: [6, 4, 2, 0, -1, 0, 1, 2, 3, 2],
  },
  {
    name: "Latin",
    nameES: "Latina",
    icon: Music,
    values: [3, 2, 1, 0, 1, 2, 3, 2, 1, 2],
  },
  {
    name: "Rock",
    nameES: "Rock",
    icon: Guitar,
    values: [4, 3, 1, 0, -2, -1, 2, 3, 4, 3],
  },
  {
    name: "Acoustic Clarity",
    nameES: "Claridad Acústica",
    icon: Lightbulb,
    values: [0, 0, 1, 2, 3, 4, 3, 2, 1, 0],
  },
  {
    name: "Vocal Warmth",
    nameES: "Calidez Vocal",
    icon: Mic,
    values: [-1, 0, 2, 4, 5, 4, 2, 0, -1, -2],
  },
  {
    name: "Heavy Bass",
    nameES: "Graves Potentes",
    icon: Volume2,
    values: [8, 7, 5, 3, 1, 0, 0, 0, 0, 0],
  },
  {
    name: "Live",
    nameES: "En Vivo",
    icon: Headphones,
    values: [2, 2, 1, 0, 1, 2, 3, 3, 2, 2],
  },
];
        ...
        {enabled ? (
          ...
          <div className="text-center py-8 text-slate-400 dark:text-slate-300">
            ...
            <p className="text-white text-sm">
              Enable Audio EQ to access the professional equalizer
            </p>
          </div>
        )}
      </CardContent>
