...
const GENRE_PRESETS = [
  { name: 'Flat', icon: '⚡', gradient: 'from-slate-500 to-gray-600' },
  { name: 'Bass Boost', icon: '🔊', gradient: 'from-red-500 to-orange-600' },
  { name: 'Treble Boost', icon: '🎶', gradient: 'from-cyan-500 to-blue-600' },
  { name: 'Jazz', icon: '🎷', gradient: 'from-amber-500 to-yellow-600' },
  { name: 'Classical', icon: '🎻', gradient: 'from-purple-500 to-pink-600' },
  { name: 'Electronic', icon: '🎹', gradient: 'from-cyan-500 to-teal-600' },
  { name: 'V-Shape', icon: '📐', gradient: 'from-indigo-500 to-purple-600' },
  { name: 'Vocal', icon: '🎙️', gradient: 'from-fuchsia-500 to-purple-600' },
  { name: 'Rock', icon: '🎸', gradient: 'from-orange-500 to-red-600' },
  { name: 'Hip-Hop', icon: '🎤', gradient: 'from-green-500 to-emerald-600' },
  { name: 'Podcast', icon: '📻', gradient: 'from-pink-500 to-rose-600' },
  { name: 'Live', icon: '🎵', gradient: 'from-lime-500 to-green-600' },
];
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-base text-slate-200 leading-relaxed">
                {language === 'ES' 
                  ? 'Los datos de tu audio nunca se suben a ningún servidor, todo el procesamiento ocurre localmente en tu navegador. Esto garantiza que tu audio permanezca seguro y en tu computadora.'
                  : 'Your audio data is never uploaded to any server, all processing happens locally in your browser. This ensures your audio remains secure and stays on your computer.'}
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <Card className="bg-gradient-to-br from-slate-900/95 to-cyan-900/40 border-2 border-dashed border-cyan-500/60 hover:border-cyan-400 transition-all shadow-xl shadow-cyan-500/20">
          <CardContent className="p-6">
            <h3 className="text-xl font-bold text-white mb-4 text-center bg-gradient-to-r from-cyan-200 to-blue-200 bg-clip-text text-transparent">
            ...
            <div className="text-center mb-4">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white font-bold shadow-lg shadow-cyan-500/50 hover:scale-105 transition-all"
              >
        ...
        <Card className="bg-gradient-to-br from-slate-900/95 to-purple-900/40 border-2 border-dashed border-purple-500/60 hover:border-purple-400 transition-all shadow-xl shadow-purple-500/20">
          <CardContent className="p-6">
            <h3 className="text-xl font-bold text-white mb-4 text-center bg-gradient-to-r from-purple-200 to-pink-200 bg-clip-text text-transparent">
            ...
            <div className="text-center mb-4">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold shadow-lg shadow-purple-500/50 hover:scale-105 transition-all"
              >
                <Upload className="h-5 w-5 mr-2" />
              ...
              return (
                <Button
                  ...
                  className={`
                    ...
                    ${isSelected 
                      ? 'border-white shadow-2xl shadow-white/50 animate-pulse scale-105' 
                      : 'border-white/30 hover:border-white/60 shadow-lg hover:shadow-2xl'
                    }
                  `}
                >
