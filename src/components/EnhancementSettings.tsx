...
export const EnhancementSettings = ({ onEnhance, isProcessing, hasFiles, onSaveLocationChange }: EnhancementSettingsProps) => {
  console.log('EnhancementSettings rendering with props:', { isProcessing, hasFiles });
  ...
  console.log('About to render EnhancementSettings');
  ...
  try {
    ...
    console.error('Error rendering EnhancementSettings:', error);
    return (
      <div className="p-8 text-center">
        <h2 className="text-xl font-bold text-red-400 mb-2">Enhancement Settings Error</h2>
        <p className="text-red-300">There was an error loading the enhancement settings. Please check the console for details.</p>
      </div>
    );
  }
};
