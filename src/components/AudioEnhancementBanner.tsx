...
import { FileAudio, Waveform, Zap } from 'lucide-react';

export const AudioEnhancementBanner = () => {
  return (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 p-6 mb-8">
      ...
      <div className="relative z-10 text-center">
        <div className="flex items-center justify-center gap-3 mb-2">
          ...
          <h1 className="text-4xl font-bold text-white">
            Audio Enhancer
            <span className="ml-2 text-2xl font-light text-blue-200">Pro</span>
          </h1>
        </div>
