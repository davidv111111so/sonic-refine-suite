...
export const AudioVisualizer: React.FC<AudioVisualizerProps> = ({
  ...
  return (
    <Card className="bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 p-6 space-y-4">
      ...
      {/* Spectrum Analyzer */}
      <div>
        <label className="text-sm text-slate-400 mb-2 block">Spectrum Analyzer</label>
        <canvas
          ref={canvasRef}
          width={800}
          height={200}
          className="w-full rounded-lg border border-slate-700 shadow-inner"
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          ...
          <div className="relative h-4 bg-slate-800 rounded-full overflow-hidden">
            <div
              ...
              style={{ width: `${vuMeterLeftRef.current}%` }}
            />
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          <div className="relative h-4 bg-slate-800 rounded-full overflow-hidden">
            <div
              className="absolute inset-y-0 left-0 bg-gradient-to-r from-green-500 via-yellow-500 to-red-500 transition-all duration-100"
              style={{ width: `${vuMeterRightRef.current}%` }}
            />
          </div>
        </div>
      </div>
