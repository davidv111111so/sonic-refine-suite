...
import { Settings, Zap, Volume2, Headphones, Sparkles, Trash2, Info } from 'lucide-react';
...
export const CompactEnhancementSettings = ({
  ...
  const ToggleButton = ({ enabled, onToggle, icon, label, color, description }: any) => (
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          onClick={onToggle}
          className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-500 transform hover:scale-110 ${enabled
  ...
  const CustomSlider = ({ enabled, value, onChange, label, max = 100, color, description }: any) => (
          ...
          <CardContent className="pt-0 space-y-6">
            ...
            <div className="flex items-center justify-around p-6 bg-gradient-to-r from-slate-800/80 to-slate-700/80 rounded-xl border border-slate-600 backdrop-blur-sm">
              ...
              <div className="flex flex-col items-center gap-3">
                <ToggleButton
                  ...
                  label="Compression"
                  description="Balances volume levels for a consistent sound"
                  color="#f59e0b"
                />
              ...
              <div className="flex flex-col items-center gap-3">
                <ToggleButton
                  ...
                  description="Expands the stereo field for a wider sound"
                  color="#a855f7"
                />
            ...
            <div className="space-y-4">
              <CustomSlider
                ...
                label="Noise Reduction"
                description="Adjust the amount of noise reduction applied."
                color="#10b981"
              />
              ...
              <CustomSlider
                ...
                label="Compression"
                description="Adjust the intensity of dynamic range compression."
                color="#f59e0b"
              />
              ...
              <CustomSlider
                ...
                label="Stereo Widening"
                description="Adjust the width of the stereo field."
                color="#a855f7"
              />
            </div>
            ...
            <div className="space-y-3 pt-4 border-t border-slate-700">
              <div className="flex items-center space-x-3">
                ...
                />
                <label htmlFor="normalization" className="text-sm text-slate-300 font-medium flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="bg-slate-900 border-slate-700 text-slate-200 p-2 text-xs max-w-[200px]">
                      Normalizes audio to -14 LUFS standard.
                    </TooltipContent>
                  </Tooltip>
                </label>
              </div>
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  className="border-slate-500"
                />
                <label htmlFor="highfreq" className="text-sm text-slate-300 font-medium flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="bg-slate-900 border-slate-700 text-slate-200 p-2 text-xs max-w-[200px]">
                      Restores lost high-frequency content for clearer sound.
                    </TooltipContent>
                  </Tooltip>
                </label>
              </div>
            ...
            <Button
              ...
              className={`w-full h-14 text-xl font-bold relative overflow-hidden transition-all duration-500 transform hover:scale-105 ${!hasFiles || isProcessing
