        ...
        <div className="flex flex-col h-full w-12 bg-[#121212] border-l border-[#27272a] items-center py-2 gap-2 relative">
            ...
            >
                ...
                <Fader
                    ...
                    value={pitch} // 0 to 1 mapping for UI, need to convert to rate
                    onChange={setPitch}
            ...
            <div className="flex gap-1 w-full px-1">
                <button
                    className="flex-1 h-6 bg-[#27272a] border border-[#3f3f46] rounded-sm flex items-center justify-center text-neutral-400 hover:text-white active:bg-[#3f3f46]"
                    onMouseDown={() => onNudge('left', true)}
                    onMouseUp={() => onNudge('left', false)}
                    onMouseLeave={() => onNudge('left', false)}
                >
                    <ChevronLeft className="w-3 h-3" />
                </button>
                <button
                    className="flex-1 h-6 bg-[#27272a] border border-[#3f3f46] rounded-sm flex items-center justify-center text-neutral-400 hover:text-white active:bg-[#3f3f46]"
                    onMouseDown={() => onNudge('right', true)}
                    onMouseUp={() => onNudge('right', false)}
                    onMouseLeave={() => onNudge('right', false)}
                >
