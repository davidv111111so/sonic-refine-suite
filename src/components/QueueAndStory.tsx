      ...
      <Card className="bg-gradient-to-br from-slate-800 to-slate-900 border-slate-600 shadow-lg">
        ...
        <CardContent className="pt-0">
          {processingFiles.length > 0 ? (
            ...
            <p className="text-slate-400 text-center py-4">No files currently processing</p>
          )}
        </CardContent>
      </Card>
          ...
          {queueFiles.length > 0 ? (
            <div className="space-y-2">
              {queueFiles.map((file, index) => (
                <div key={file.id} className="flex items-center gap-3 p-2 bg-slate-800/30 rounded">
