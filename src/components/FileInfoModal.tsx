    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-slate-800 border-slate-600 text-white max-w-md">
        ...
        <div className="space-y-4">
          {/* File Name */}
          <div>
            <label className="text-sm text-slate-400 mb-1 block">File Name</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div>
                <p className="text-white font-mono">{formatFileSize(file.size)}</p>
            ...
            <div>
              ...
              <Badge variant="outline" className="bg-slate-700 text-white border-slate-500">
                {fileType}
              </Badge>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {file.duration && (
              <div>
                ...
                <p className="text-white font-mono">{formatDuration(file.duration)}</p>
              </div>
            )}
          ...
          {file.sampleRate && (
            <div>
              <label className="text-sm text-slate-400 mb-1 block">Sample Rate</label>
          ...
          <div>
            ...
            {file.processingStage && (
              <p className="text-slate-400 text-sm mt-1">{file.processingStage}</p>
            )}
          </div>
        </div>
      </DialogContent>
