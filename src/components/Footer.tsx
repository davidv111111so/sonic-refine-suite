...
export const Footer = () => {
  return <footer className="mt-12 pt-8 border-t border-slate-700 bg-gradient-to-r from-slate-900/50 to-slate-800/50 bg-blue-950 mx-px my-[131px] px-[34px] py-px">
