...
const Index = () => {
  ...
  return (
    <div className="min-h-screen transition-colors duration-300 bg-background relative overflow-hidden">
      ...
      {/* Landing Page Deep-Link Footer */}
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 border-t border-slate-700/50 px-4 py-2 flex items-center justify-between shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
        ...
        <Button
          ...
          className="text-xs text-cyan-400/80 hover:text-cyan-300 hover:bg-cyan-500/10 gap-1.5 font-medium"
        >
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
          Discover Level Audio
        </Button>
      </div>
    </div>
  );
