...
const translations = {
  EN: {
    ...
    'aiMastering.masterWithReference': 'Master with Your Own Reference',
    'aiMastering.customReferenceDescription': 'Upload your target track and a reference track to match its sound characteristics',
    'aiMastering.masterWithPresets': 'Master with Genre Presets',
    'aiMastering.genrePresetsDescription': 'Select from professional presets tailored to your music genre',
  ...
  ES: {
    ...
    'aiMastering.masterWithReference': 'Masterizar con Tu Propia Referencia',
    'aiMastering.customReferenceDescription': 'Sube tu pista objetivo y una pista de referencia para igualar sus características de sonido',
    'aiMastering.masterWithPresets': 'Masterizar con Presets de Género',
    'aiMastering.genrePresetsDescription': 'Selecciona entre presets profesionales adaptados a tu género musical',
